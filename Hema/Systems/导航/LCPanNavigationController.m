...
- (void)pan:(UIPanGestureRecognizer *)pan
{
    ...
    switch (state) {
        ...
        case UIGestureRecognizerStateChanged:{
            ...
            if (translationPoint.x > UI_View_Width) translationPoint.x = UI_View_Width;
            
            CGFloat k = translationPoint.x / UI_View_Width;
        ...
        case UIGestureRecognizerStateEnded:{
            ...
            [UIView animateWithDuration:0.3 animations:^{
                ...
                self.visibleViewController.view.transform = reset ? CGAffineTransformIdentity : CGAffineTransformTranslate(CGAffineTransformIdentity, UI_View_Width, 0);
