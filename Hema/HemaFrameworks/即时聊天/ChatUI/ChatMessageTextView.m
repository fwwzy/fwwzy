...
@implementation ChatMessageTextView
...
- (void)setPlaceHolder:(NSString *)placeHolder
{
    ...
    NSUInteger maxChars = [ChatMessageTextView maxCharactersPerLine];
...
{
    return [ChatMessageTextView numberOfLinesForMessage:self.text];
}
...
{
    return (text.length/[ChatMessageTextView maxCharactersPerLine]) + 1;
}
