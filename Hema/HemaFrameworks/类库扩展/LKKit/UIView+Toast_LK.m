...
static const CGSize  CSToastShadowOffset        = { 3.0, 3.0 };
...
// tag
static const  int MessageLabelTag               = 56981;
...
- (void)makeToast:(NSString *)message messageColor:(UIColor *)color duration:(CGFloat)interval position:(id)position
{
    UIView *toast = [self viewForMessage:message title:nil image:nil];
    UILabel *messageLabel = (UILabel *)[toast viewWithTag:MessageLabelTag];
    if (color)
    {
...
static  __weak UIView *lastToast;
