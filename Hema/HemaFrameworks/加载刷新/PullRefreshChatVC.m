...
@implementation PullRefreshChatVC
@synthesize mytable;
...
-(void)loadMySet
{
    mytable = [[UITableView alloc]initWithFrame:CGRectMake(0, 0, UI_View_Width, UI_View_Height) style:UITableViewStylePlain];
