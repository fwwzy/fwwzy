...
// 文件的存放路径（caches）
#define HSFileFullpath(url) [HSCachesDirectory stringByAppendingPathComponent:[NSString stringWithFormat:@"%@.%@",HSFileName(url),[[url componentsSeparatedByString:@"."]lastObject]]]
