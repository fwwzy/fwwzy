...
- (void)setButtonStyle:(JGActionSheetButtonStyle)buttonStyle forButton:(UIButton *)button
{
    ...
    else if (buttonStyle == JGActionSheetButtonStyleRed)
    {
        ...
        backgroundColor = RGB_UI_COLOR(231.0f, 76.0f, 60.0f);
        borderColor = RGB_UI_COLOR(192.0f, 57.0f, 43.0f);
    }
    else if (buttonStyle == JGActionSheetButtonStyleGreen)
    {
        ...
        backgroundColor = RGB_UI_COLOR(46.0f, 204.0f, 113.0f);
        borderColor = RGB_UI_COLOR(39.0f, 174.0f, 96.0f);
    }
    else if (buttonStyle == JGActionSheetButtonStyleBlue)
    {
        ...
        backgroundColor = RGB_UI_COLOR(52.0f, 152.0f, 219.0f);
        borderColor = RGB_UI_COLOR(41.0f, 128.0f, 185.0f);
    }
