...
- (instancetype)initWithFrame:(CGRect)frame
{
    ...
    if (self) {
        ...
        maskView.backgroundColor = [BB_Red_Color colorWithAlphaComponent:0.3];
        ...
        _blurBGView.underlyingView = [HemaFunction xfuncGetAppdelegate].window;
    }
    return self;
}
...
- (void)show
{
    UIWindow *keyWindow = [HemaFunction xfuncGetAppdelegate].window;
