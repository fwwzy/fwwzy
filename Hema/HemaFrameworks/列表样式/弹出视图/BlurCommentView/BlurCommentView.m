...
{
    [BlurCommentView commentshowInView:[HemaFunction xfuncGetAppdelegate].window success:success delegate:nil];
}

+ (void)commentshowDelegate:(id<BlurCommentViewDelegate>)delegate
{
    [BlurCommentView commentshowInView:[HemaFunction xfuncGetAppdelegate].window success:nil delegate:delegate];
}
