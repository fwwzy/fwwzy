...
- (void)initResourceFormPuzzle
{
    ...
    for (int i = 0; i < [imageNameArray count]; i++)
    {
        ...
        [button setBackgroundImage:[UIImage imageNamed:@"R选中边框样式.png"] forState:UIControlStateSelected];
...
-(void)resetStoryBoradImg
{
    ...
    for (int i = 0; i < [imageNameArray count]; i++)
    {
        UIButton *button = (UIButton*)[_storyboardView viewWithTag:i+1];
        [button setImage:[UIImage imageNamed:[imageNameArray objectAtIndex:i]] forState:UIControlStateNormal];
