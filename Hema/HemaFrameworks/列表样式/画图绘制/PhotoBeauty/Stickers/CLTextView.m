...
- (id)init
{
    ...
    if(self)
    {
        ...
        _label.shadowOffset = CGSizeMake(0, 2);
        _label.shadowBlur = 5;
        _label.innerShadowColor = nil;
        _label.innerShadowOffset = CGSizeMake(0, 1);
        _label.innerShadowBlur = 2;
        _label.textColor = BB_Red_Color;
        ...
        [_deleteButton setImage:[UIImage imageNamed:@"R美图删除叉号.png"] forState:UIControlStateNormal];
...
{
    if ([HemaFunction xfunc_check_strEmpty:_text])
    {
...
- (void)setLabelStyle:(LabelStyle)styleID
{
    ...
    switch (styleID)
    {
        ...
        default:
        {
            _label.shadowColor = BB_Blue_Color;
            _label.shadowOffset = CGSizeMake(0, 2);
