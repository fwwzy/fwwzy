...
+ (CGRect)CalculationCGRect:(float)i andY:(float)y{
    return CGRectMake(10+y*((UI_View_Width-30)/3+5), 60+i*((UI_View_Width-30)/3+5), (UI_View_Width-30)/3, (UI_View_Width-30)/3);
}

#pragma mark--返回图片的位置CGRect(留言板)
+ (CGRect)CalculationMassageCGRect:(float)i andY:(float)y{
    return CGRectMake(64+y*((UI_View_Width-84)/3+5), 60+i*((UI_View_Width-84)/3+5), (UI_View_Width-84)/3, (UI_View_Width-84)/3);
}
