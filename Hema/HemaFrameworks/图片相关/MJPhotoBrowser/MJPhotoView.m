...
- (void)scrollViewDidEndZooming:(UIScrollView *)scrollView withView:(UIView *)view atScale:(CGFloat)scale
{
    ...
    [self actionActive];
    if (_imageView.frame.size.height>=boundsHeight)
    {
        [_imageView setFrame:CGRectMake(0, 0, _imageView.frame.size.width, _imageView.frame.size.height)];
    }else
    {
        [_imageView setFrame:CGRectMake(0, (boundsHeight-_imageView.frame.size.height)/2, _imageView.frame.size.width, _imageView.frame.size.height)];
    }
