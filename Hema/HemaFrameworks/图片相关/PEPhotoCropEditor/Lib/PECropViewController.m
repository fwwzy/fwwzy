...
- (void)viewDidLoad
{
    ...
    [self.navigationItem setNewTitle:@"裁剪"];
    [self.navigationItem setLeftItemWithTarget:self action:@selector(cancel:) image:BackImgName];
    [self.navigationItem setRightItemWithTarget:self action:@selector(done:) title:@"完成"];

    if (!self.toolbarItems) {
        UIBarButtonItem *flexibleSpace = [[UIBarButtonItem alloc] initWithBarButtonSystemItem:UIBarButtonSystemItemFlexibleSpace
                                                                                       target:nil
                                                                                       action:nil];
        UIBarButtonItem *constrainButton = [[UIBarButtonItem alloc] initWithTitle:@"约束"
