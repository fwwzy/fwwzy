...
{
    _line = [[UIView alloc] initWithFrame:CGRectMake(15.0f, NAV_TAB_BAR_HEIGHT - 3.0f, width - 27.0f, 3.0f)];
    _line.backgroundColor = BB_Red_Color;
...
- (NSArray *)getButtonsWidthWithTitles:(NSArray *)titles;
{
    ...
    for (NSString *title in titles)
    {
        ...
        NSNumber *width = [NSNumber numberWithFloat:size.width + UI_View_Width/5];
...
- (void)setCurrentItemIndex:(NSInteger)currentItemIndex
{
    ...
    [UIView animateWithDuration:0.2f animations:^{
        _line.frame = CGRectMake(button.frame.origin.x + 16.0f, _line.frame.origin.y, [_itemsWidth[currentItemIndex] floatValue] - 27.0f, _line.frame.size.height);
    }];
}
